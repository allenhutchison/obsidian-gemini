...
- **Skills Import:** Import external SKILL.md files into your vault as custom prompts. Configure an external folder path containing skill definitions, and use the command palette to import them. Skills are converted to prompt templates that enhance the AI's capabilities.
