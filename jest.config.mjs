...
export default {
	...
	// This pattern will find .test.ts or .spec.ts (and .js) files in the test and src directories.
	testMatch: ['<rootDir>/test/**/?(*.)+(spec|test).[tj]s', '<rootDir>/src/**/?(*.)+(spec|test).[tj]s'],
