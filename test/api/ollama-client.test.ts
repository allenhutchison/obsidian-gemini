...
// Hoist-safe mock storage
const ollamaCalls: { chat: jest.Mock; generate: jest.Mock; abort: jest.Mock } = {
	chat: jest.fn(),
	generate: jest.fn(),
	abort: jest.fn(),
};
...
const buildPlugin = () =>
	({
		...
		agentsMemory: { read: jest.fn().mockResolvedValue('') },
